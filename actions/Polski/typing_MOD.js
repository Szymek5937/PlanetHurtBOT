module.exports = {
	...
	<div>
		<div style="float: left; width: 35%;">
			...
			<select id="EliteArtzIsPro" class="round">
				<option value="0" selected>Zaczyna pisac</option>
				<option value="1">Przestaje pisac</option>
			</select>
		</div><br>
	</div><br><br>
	<div>
		<div style="float: left; width: 35%;">
			Kanal na ktorym ma pisac:<br>
	...
	<div>
		<p>
			Mozesz zatrzymac pisanie uzywajac <b>Przestaje pisac</b>
		</p>
	</div><br>`
	},
