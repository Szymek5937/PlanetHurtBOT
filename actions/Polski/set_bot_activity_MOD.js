    ...
    <div id="mod-container">
					<div id="main-body">
						...
						<div style="display: flex;">
							<div style="width: 50%; padding-right: 10px">
								...
								<select id="activity" class="round" style="width: 100%;">
									...
									<option value="1">Slucha</option>
									<option value="2">Oglada</option>
									<option value="3">Streamuje na Twitch</option>
								</select>
							</div>
						...
						<div id="urlArea" class="hidden">
							URL Steeamu na Twitch<br>
							<input id="url" class="round" type="text" autofocus="autofocus" placeholder='Dziala tylko z http://twitch.tv/ URL'
							 style="width: 100%;">
						</div>
						<br>
						Ten mod wymaga najnowszej wersji Discord.js<br>
						Tutorial: https://youtu.be/mrrtj5nlV58<br>
					</div>
