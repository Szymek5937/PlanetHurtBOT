module.exports = {
	...
	<div style="float: left; width: 80%; padding-top: 8px;">
		...
		<select id="info" class="round">
			<optgroup label="Dzialanie bota">
				<option value="23">Dzialanie w dniach</option>
				<option value="24">Dzialanie w godzinach</option>
				<option value="25">Dzialanie w minutach</option>
				<option value="26">Dzialanie w sekundach</option>
			</optgroup>
			<optgroup label="Wartosci">
				<option value="3">Calkowita liczba serwerow</option>
				<option value="4">Calkowita liczba uzytkownikow</option>
				<option value="10">Calkowita liczba kanalow</option>
				<option value="11">Calkowita liczba emoji</option>
        <option value="32">Calkowita liczba komend</option>
        <option value="33">Calkowita liczba zdarzen</option>
				<option value="9">Liczba polaczen z kanalem glosowym</option>
      </optgroup>
      <optgroup label="Serwery na ktorych jest bot">
				<option value="16">Objekty serwerow</option>
				<option value="17">Nazwy serwerow</option>
				<option value="18">ID serwerow</option>
			<optgroup label="Informacje o bocie">
				<option value="19">Aktualny prefix</option>
				<option value="20">ID</option>
				<option value="44">ID Wlasciciela</option>
				<option value="28">Bot OS (Platforma Procesowa)</option>
				<option value="30">Katalog bota</option>
				<option value="8">TOKEN (OSTROZNIE)</option>
			</optgroup>
			<optgroup label="Pomiary systemowe">
				<option value="29">Uzycie CPU (MB)</option>			
				<option value="35">Liczba rdzeni CPU</option>			
				<option value="36">Calowita pamiec (GB)</option>
				<option value="37">Calkowita pamiec (MB)</option>
				<option value="38">Dostepna pamiec (GB)</option>
				<option value="39">Dostepna pamiec (MB)</option>
				<option value="40">Dostepna pamiec (%)</option>				
				<option value="41">Uzyta pamiec (GB)</option>
				<option value="42">Uzyta pamiec (MB)</option>
				<option value="43">Uzyta pamiec (%)</option>
			</optgroup>
			<optgroup label="Pomiary Bota">
				<option value="27">Pamiec (RAM) uzyta w MB</option>
				<option value="1">Gotowy od</option>
				<option value="34">Gotowy od [unix timestamp]</option>
				<option value="2">Ping</option>
				<option value="5">Ping (zaokraglony)</option>
				<option value="12">Poprzednie pingi</option>
			</optgroup>
