...
div.embed { /* <div class="embed"></div> */
    ...
    itemList:  [
        { name:'Głośność (1-100)', type: "Number"},
        { name:'Czy gra', type: "Boolean"},
        { name:'Czas Startu (sekundy)', type: "Seconds"},
        { name:'URL Listy kolejki', type: "List"},
        { name:'URL kolejnej piosenki w kolejce', type: "Url"},
        { name:'Długość kolejki', type: "Number"},
        { name:'Bitrate', type: "Number"},
        { name:'Passes', type: "Number"},
        { name:'Aktualna pozycja szukania (sekundy)', type: "Seconds"}
    ],
