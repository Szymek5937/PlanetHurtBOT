...
html: function(isEvent, data) {
	...
	<div class="help">
		...
		Pomocne filtry:<br>
		<pre>
		Jesli wiadomosc JEST odpowiedzia: content === 'response'
		jesli wiadomosc POSIADA slowo:  content.includes('response')
		jesli wiadomosc ZACZYNA SIE slowem: content.startsWith('response')
		jesli wiadomosc KONCZY SIE slowem: content.endsWith('response')
		Aby uzyc regex: content.match(/response/)	
		</pre>
		Wiecej funkcji:: <u><span class="wrexlink" data-url="https://www.w3schools.com/Jsref/jsref_obj_string.asp">tutaj</span></u>
	</div>
    <div>
    ...
    <div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            ...
            <select id="iftrue" class="round" onchange="glob.onChangeTrue(this)">
					 ...
					 <option value="3">Pomin akcje</option>
				</select>
        </div>
    ...
    <div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            ...
            <select id="iffalse" class="round" onchange="glob.onChangeFalse(this)">
				<option value="0">Kontynuuj akcje</option>
				<option value="1" selected>Zatrzymaj sekwencje akcji</option>
				<option value="2">Skocz do akcji</option>
				<option value="3">Pomin akcje</option>
		 </select>
        </div>
