...
<div style="float: left; width: 50%;">
	...
	Autor:<br>
	<input id="author" class="round" type="text" placeholder="Zostaw puste by zdeazaktywowac"><br>
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Zostaw puste by dodac domyslnie"><br>
	Uzyj znaku czasu (Timestamp):<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Zostaw puste by zdeazaktywowac"><br>
	URL ikony autora:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Zostaw puste by zdeazaktywowac"><br>
	URL Zdjecia:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Zostaw puste by zdeazaktywowac"><br>
	URL Miniaturki:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Zostaw puste by zdeazaktywowac"><br>
</div>
<div>
