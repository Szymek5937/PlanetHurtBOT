module.exports = {
	...
	name: "Pobierz informacje o zalaczniku",
...
<div style="float: left; width: 80%; padding-top: 8px;">
	...
	<select id="info" class="round">
		<option value="0">URL zalacznika</option>
		<option value="1">Nazwa pliku zalacznika</option>
		<option value="2">Wysokosc zalacznika</option>
		<option value="3">Szerokosc zalacznika</option>
		<option value="4">Kontent wiadomosci zalacznika</option>
		<option value="5">Waga zalacznika (KB)</option>
		<option value="6">ID wiadomosci zalacznika</option>
	</select>
</div><br><br>
	<div style="float: left; width: 35%; padding-top: 8px;">
		Zapisz w:<br>
