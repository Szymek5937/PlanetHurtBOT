...
name: "Ustaw stopke wiadomosci Embed",
...
<div style="padding-top: 8px;">
	Stopka:<br>
	<textarea id="message" rows="3" placeholder="Wpisz stopke tutaj..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div style="float: left; width: 99%;">
	Ikona URL stopki:<br>
	<input id="footerIcon" class="round" type="text" placeholder="Zostaw puste by zdezaktywowac"><br>
</div>`
},
