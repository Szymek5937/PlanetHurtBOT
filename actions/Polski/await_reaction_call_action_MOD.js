...
name: "Czekanie na dodanie reakcji",
...
Max reakcji:<br>
<input id="max" class="round" type="text" value="1" placeholder="Opcjonalnie"><br>
</div>
<div style="float: left; width: 49%;">
Max Czas (milisekundy):<br>
<input id="time" class="round" type="text" value="60000" placeholder="Opcjonalnie"><br>
</div><br><br><br>
<div style="float: left; width: 50%;">
Max Emotek:<br>
<input id="maxEmojis" class="round" type="text" placeholder="Opcjonalnie"><br>
</div>
<div style="float: left; width: 49%;">
Max Uzytkownikow:<br>
<input id="maxUsers" class="round" type="text" placeholder="Opcjonalnie"><br>
</div><br><br><br>
    <div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            Na dodanie reakcji:<br>
