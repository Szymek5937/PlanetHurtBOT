...
<div>
	<div style="float: left; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Szukaj jako kontent</option>
			<option value="1">Szukaj poprzez ID</option>
		</select>
	</div><br><br><br>
	<div style="float: left; width: 70%;">
		Tekst szukania:<br>
...
<div>
	<p>
	<u>Uwaga:</u><br>
	Ten mod może znaleźć wiadomości tylko według <b>treści</b> w ciągu ostatnich 100 wiadomości.<br>
	Jeśli istnieje wiele wiadomości o tej samej treści, bot zawsze używa najstarszej wiadomości (po starcie).
</div>`;
},
